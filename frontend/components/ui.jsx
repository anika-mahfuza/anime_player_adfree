...
export function TopNav({ children, rightSlot, backHref, backLabel = 'Back' }) {
  return (
    <header className="sticky top-0 z-[320] overflow-visible border-b border-white/6 bg-[rgba(8,10,14,0.78)] backdrop-blur-2xl">
      <div className="mx-auto flex max-w-screen-xl flex-wrap items-center gap-3 px-4 py-3 sm:flex-nowrap sm:gap-4 sm:px-6 sm:py-4">
        ...
        <div className="relative z-[330] min-w-0 basis-full flex-1 sm:basis-auto">{children}</div>
